...
public class CommonUtil {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            ((Activity) context).getWindow().getDecorView().setSystemUiVisibility(
                    View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                            ...
                            | View.SYSTEM_UI_FLAG_IMMERSIVE);//bar
    ...
    public static void showNavKey(Context context, boolean isLightFont) {
        ...
        int option = -1;
        if (isLightFont) {
            option = View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_VISIBLE;// 白色字体
        } else {
            option = View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR;// 黑色字体
        }
